namespace Kathulhu
{
    ...
    ////The different directions from a pointy-topped hex to an adjacent hex. (A flat-topped hex is a pointy-topped hex that has been rotated 30degrees clockwise)
